...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public static final String COLUMN1_NAME_TITLE_TABLE1 = "Name";
    public static final String COLUMN2_NAME_TITLE_TABLE1 = "Path";
    ...
    public void addRow(entry e)
    {
        ...
        x.put(ID,id);
        x.put(COLUMN1_NAME_TITLE_TABLE1,e.getName());
        x.put(COLUMN2_NAME_TITLE_TABLE1,e.getPath());
    ...
    public entry getresult(int x){
        ...
        if(!c.isAfterLast())
        {
            ...
            if(c.getString(c.getColumnIndex(COLUMN1_NAME_TITLE_TABLE1))!=null)
                e.setName(c.getString(c.getColumnIndex(COLUMN1_NAME_TITLE_TABLE1)));
            if(c.getString(c.getColumnIndex(COLUMN2_NAME_TITLE_TABLE1))!=null)
                e.setPath(c.getString(c.getColumnIndex(COLUMN2_NAME_TITLE_TABLE1)));
        }
        return e;
    }
    public int rCount() {
